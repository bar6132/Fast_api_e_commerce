...
class Product(Model):
    ...
    original_price = fields.IntField(max_digits=12, decimal_places=2)
    new_price = fields.IntField(max_digits=12, decimal_places=2)
...
business_pydanticIn = pydantic_model_creator(Business, name="BusinessIn",
                                             exclude=("logo", "id"))

product_pydantic = pydantic_model_creator(Product, name="Product")
product_pydanticIn = pydantic_model_creator(Product, name="ProductIn",
                                            exclude=("percentage_discount", 'id', 'product_image',
                                                     'date_published'))
